               ...
               <div class="join-group">
                   <div class="join-row email">
                       <div class="join-item">
                           ...
                           <input type="text" id="firstEmail" class="ui-ipt email blankChk" name="firstEmail"><span>@</span><input type="text" id="lastEmail" class="ui-ipt email blankChk" name="lastEmail">
                   ...
                   <div class="join-row">
                       <div class="join-item">
                           ...
                           <input id="firstPwd" type="password" class="ui-ipt blankChk" maxlength="15">
                       ...
                       <div class="join-item">
                           ...
                           <input id="secondPwd" type="password" class="ui-ipt blankChk" name="pwd" maxlength="15">
                           <br>
                           <span class="txt-warning"></span>
                       </div>
                   </div>
                   <div class="join-row phone ipt-bar">
                       <div class="join-item">
                           ...
                           <span class="bar"></span>
                           <input type="text" id="firstPhoneNum" class="ui-ipt ipt-phone num blankChk" name="firstPhoneNum" >
                           <span class="bar"></span>
                           <input type="text" id="lastPhoneNum" class="ui-ipt ipt-phone num blankChk" name="lastPhoneNum" >
                   ...
                   <div class="join-row">
                       <div class="join-item">
                           ...
                           <div class="sub-addr-wrap mgt-10"><input type="text" id="roadAddress" class="ui-ipt blankChk" name="roadAddress" ></div>
                      </div>
                   </div>   
                   <div class="join-row">
                       <div class="join-item">
                           <h3 class="item-tit txt-regular"><span>아파트 이름</span><span class="point">*</span></h3>
                           <input type="text" id="buildingName" class="ui-ipt blankChk" name="buildingName" >
                       </div>
                   </div>
                   <div class="join-row phone ipt-bar">
                       <div class="join-item">
                           <h3 class="item-tit txt-regular"><span>단위 요금</span><span class="point">*</span></h3>
                           <input type="text" id="fee" class="ui-ipt ipt-phone blankChk" name="fee" maxlength="10"> 원 (15분당 요금)
                           <span class="txt-warning"></span>
                   ...
                   <div class="join-row ipt-bar">
                       <div class="join-item">
                           ...
                           <input type="text" id="openTime" class="ui-ipt limitTime time blankChk" name="openTime" maxlength="2"> 시<span> ~ </span><input type="text" id="closeTime" class="ui-ipt limitTime time blankChk" name="closeTime" maxlength="2">시
                           <span class="txt-warning"></span>
                           <br>
                   ...
                   <div class="join-row phone ipt-bar">
                       <div class="join-item">
                           ...
                           <input type="text" id="bookableCount" class="ui-ipt ipt-phone blankChk" name="bookableCount" maxlength="6"><span> / </span><input type="text" id="totalCount" class="ui-ipt ipt-phone blankChk" name="totalCount" maxlength="6">
                           <span class="txt-warning"></span>
                       </div>
                   </div> 
               </div>
